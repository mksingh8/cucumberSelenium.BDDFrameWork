...
@CucumberOptions(
		  features = "/home/manish/eclipse-workspace/test.shaadi.com/src/main/java/Features" //set the path of the feature files
		  ...
		  , strict = false //true: will fails execution of there are undefined or pending steps
